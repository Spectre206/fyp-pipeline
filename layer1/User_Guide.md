...
- Preserves original `timestamp`, `ingestion_time`, `node`, and `affected_component` in fused events
...
| HITL dashboard shows empty node/component | Old fused events lacked node/component | Update detectors and Fusion to propagate fields; re‑run |
